...
An interactive \emph{informal\,$\rightleftarrows$\,formal auditor} --- every
conjecture statement and proved result paired with its informal source, a
plain-English readback of the formal statement, the verbatim Rocq, and the
proved implication edges --- is at
\href{https://llm4rocq.github.io/digraph-theory/correspondence/}{\texttt{/correspondence}}.
